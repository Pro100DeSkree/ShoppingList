...
import com.deskree.shoppinglist.activities.EditOrCreateNoteActivity
import com.deskree.shoppinglist.databinding.FragmentNoteBinding
import com.deskree.shoppinglist.db.MainViewModel
import com.deskree.shoppinglist.db.NoteAdapter
...
class NoteFragment : BaseFragment(), NoteAdapter.Listener {
    ...
    override fun onClickNew() {
        editLauncher.launch(Intent(activity, EditOrCreateNoteActivity::class.java))
    }
    ...
    private fun getLayoutManager():RecyclerView.LayoutManager{
        return if(defPref.getString(getString(R.string.note_style_key), "Linear") == "Linear"){
    ...
    override fun onClickItem(note: NoteItem) {
        val intent = Intent(activity, EditOrCreateNoteActivity::class.java).apply {
